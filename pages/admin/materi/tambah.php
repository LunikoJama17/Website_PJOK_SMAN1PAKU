...
// Pastikan hanya admin atau guru yang bisa mengakses
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO materi
        (id_materi, semester_materi, judul_materi, isi_materi, video_materi, id_admin)
        VALUES
        ('$id','$sem','$judul','$isi','$video','$admin')";
...
<div class="max-w-2xl mx-auto mt-8 bg-white p-6 rounded-lg shadow">
  ...
  <form id="form-tambah" class="space-y-4">
    <div>
      <label class="block mb-1">ID Materi</label>
      <input type="text" name="id_materi" required
    ...
    <div>
      ...
      <textarea name="isi_materi" rows="4" required
